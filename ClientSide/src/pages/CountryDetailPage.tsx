  ...
  if (error || !country) {
    return (
      <div className="container mx-auto px-4 py-12 text-center">
        <div className="bg-gray-800 rounded-lg shadow-md p-8 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                <div>
                  <div className="flex items-center mb-3 text-gray-400">
                    <GlobeIcon size={18} className="mr-2 text-blue-400" />
                  ...
                  <div className="flex items-center text-gray-400">
                    <UsersIcon size={18} className="mr-2 text-blue-400" />
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-2">
              {country.timezones.map((timezone, index) => (
                <div
                  key={index}
                  className="bg-gray-700 px-3 py-2 rounded text-gray-400 text-sm"
                >
                  {timezone}
                </div>
              ))}
              ...
              <div className="flex flex-wrap gap-2">
                {country.borders.map((border) => (
                  <Link
                    key={border}
                    to={`/countries/${border}`}
                    className="bg-gray-700 hover:bg-gray-600 px-3 py-2 rounded text-sm text-gray-400 transition-colors"
                  >
                    {border}
                  </Link>
                ))}
