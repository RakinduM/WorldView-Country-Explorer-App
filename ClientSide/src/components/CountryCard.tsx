...
export const CountryCard: React.FC<CountryCardProps> = ({ country }) => {
  ...
  return (
    <Link
      ...
      className="bg-gray-800 rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow duration-300 flex flex-col h-full"
    >
      ...
      <div className="p-4 flex-grow flex flex-col">
        ...
        <div className="text-gray-400 text-sm space-y-1 mb-4">
          ...
          {country.capital && (
            <div className="flex items-center">
              <MapPinIcon size={14} className="mr-1 text-blue-400" />
        ...
        <div className="mt-auto">
          <div className="text-blue-400 text-sm font-medium hover:text-blue-500 transition-colors">
            View details →
          </div>
        </div>
      </div>
